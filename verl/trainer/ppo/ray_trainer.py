...
class RayPPOTrainer:
    ...
    def __init__(
        ...
        self.use_reward_estimator = need_reward_estimator(self.config)
...
"""
    ...
    def init_workers(self):
        ...
        if self.use_reward_estimator:
            self.reward_estimator_wg = all_wg[str(Role.RewardEstimator)]
            self.reward_estimator_wg.init_model()
